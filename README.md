...
6) как между собой связаны CLR, .NET и C#
...
1. Task, TaskScheduler, Parallel. Как в Parallel LINQ обрабатывается ParallelMergeOptions.AutoBuffered,
как поток выбирает какие результаты буферизовать. Timer, ThreadPool
